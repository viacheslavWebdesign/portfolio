			...
			<main class="col-lg-9">
				<div class="shop-head">
					...
					<div class="shop-head-nav">
						...
						<a href="shop.php" class="view-type">
							<svg viewBox="0 0 11 11">
								<use xlink:href="assets/img/set.svg#view-type1"></use>
							</svg>
						</a>
						<a href="shop-type.php" class="view-type active">
				...
				<div class="list-shop">
					<div class="shop-item">
						<a href="shop-item.php" class="item-img">
							<figure>
								<div class="full-background-wrapper">
							    	<img class="d-none d-lg-block lazyload" data-srcset="assets/img/img-shop-type-item1.jpg,
										assets/img/img-shop-type-item1@1_5x.jpg 1.5x,
										assets/img/img-shop-type-item1@2x.jpg 2x,
										assets/img/img-shop-type-item1@3x.jpg 3x,
										assets/img/img-shop-type-item1@4x.jpg 4x"
										data-src="assets/img/img-type-shop-item1.jpg">
