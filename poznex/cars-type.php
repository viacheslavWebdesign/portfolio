			...
			<main class="col-lg-9">
				<div class="cars-head">
					...
					<div class="cars-head-nav">
						...
						<a href="cars.php" class="view-type">
							<svg viewBox="0 0 11 11">
								<use xlink:href="assets/img/set.svg#view-type1"></use>
							</svg>
						</a>
						<a href="cars-type.php" class="view-type active">
						...
						<div class="cars-item">
							<div class="item-img">
								<figure>
									<div class="full-background-wrapper">
								    	<img class="lazyload" data-srcset="assets/img/img-cars-item1-type.jpg,
											assets/img/img-cars-item1-type@1_5x.jpg 1.5x,
											assets/img/img-cars-item1-type@2x.jpg 2x,
											assets/img/img-cars-item1-type@3x.jpg 3x,
											assets/img/img-cars-item1-type@4x.jpg 4x"
											data-src="assets/img/img-cars-item1-type.jpg">
							...
							<div class="item-body">
								...
								<div class="item-footer">
									<p class="btn-link">More</p>
									<p class="item-price">70 500 USD</p>
								</div>
							</div>
						</div>
					</a>
