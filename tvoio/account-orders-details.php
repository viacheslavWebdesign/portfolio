	...
	<div class="container">
		...
		<div class="account__row">
			<aside>
				...
				<a href="account-orders.php" class="account__tab account__tab_orders account__tab_current">
					<figure>
			...
			<div class="account__body account__body_details">
				<p class="account__title d-lg-none">Orders</p>
				<div class="account__link">
					<a href="account-orders.php">
						<svg viewBox="0 0 8 14" width="8" height="14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.83 14a1 1 0 01-.78-.37l-4.83-6a1 1 0 010-1.27l5-6a1.001 1.001 0 111.54 1.28L3.29 7l4.32 5.36A1 1 0 016.83 14z" fill="#818181"/></svg>
						<p>Order №651766</p>
					</a>
				</div>
				<p class="account__title d-none d-lg-block">Order Information</p>
				<div class="account-details">
					...
					<div class="account-details__row">
						...
						<p>Kyiv, st. Taras Shevchenko</p>
					</div>
				</div>
				<p class="account__title d-none d-lg-block">Products</p>
				<hr>
				<div class="details-item">
					<div class="details-item__row">
						<a href="product.php">
							<figure>
								<img src="assets/img/img-product1.jpg" width="36" height="80" class="d-none d-lg-block">
								<img src="assets/img/img-product1.jpg" width="33" height="69" class="d-lg-none">
							</figure>
						</a>
						<div class="details-item__content">
							<p class="details-item__name"><a href="product.php">Shower system N546J1_MF v251</a></p>
							<p class="details-item__id">ID: 271561</p>
						</div>
					</div>
					<p class="details-item__quantity">1 piece</p>
					<p class="details-item__total"><span class="d-lg-none">Total:</span>7.999 uah</p>
				</div>
				<div class="details-item">
					<div class="details-item__row">
						<a href="product.php">
