...
<div class="account">
	<div class="container">
		...
		<div class="account__row">
			...
			<div class="account__body account__body_orders">
				<p class="account__title">Orders</p>
				<div class="orders-table">
					<div class="orders-table__head">
						<div class="orders-table__head-item">Order №</div>
						<div class="orders-table__head-item">Order date</div>
						<div class="orders-table__head-item">Item Qty</div>
						<div class="orders-table__head-item">Sum</div>
						<div class="orders-table__head-item">Status</div>
					</div>
					<div class="orders-table__row">
						<p class="orders-table__number"><a href="account-orders-details.php">651766</a></p>
						<p class="orders-table__date">01.03.21  15:30</p>
						<p class="orders-table__quantity">5 pcs</p>
						<p class="orders-table__price">25 000 uah</p>
						<p class="orders-table__status">Completed</p>
					</div>
					<div class="orders-table__row">
						<p class="orders-table__number"><a href="account-orders-details.php">651766</a></p>
						<p class="orders-table__date">01.03.21  15:30</p>
				...
				<div class="order-item d-lg-none">
					<div class="order-item__row">
						<div class="order-item__item">
							<p>Order №</p>
							<p><a href="account-orders-details.php">15616123</a></p>
						</div>
						<div class="order-item__item">
							<p>Order date</p>
							<p>01.03.21  15:00</p>
