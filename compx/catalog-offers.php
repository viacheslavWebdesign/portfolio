...
<section class="breadcrumbs">
   <div class="container">
      <ul class="breadcrumbs__list">
         ...
         <li class="breadcrumbs__item"><a href="#">Акції</a></li>
         <li class="breadcrumbs__item">Обрана акція</li>
      </ul>
   </div>
</section>
...
<div class="offer-details">
   <div class="container">
      <div class="offer-details__row">
         <div class="offer-details__col">
            <img src="assets/img/img-offer-details1.jpg" class="lazyload d-none d-xxl-block offer-details__image">
            <img src="assets/img/img-offer-details-desktop1.jpg" class="lazyload d-none d-lg-block d-xxl-none offer-details__image">
            <img src="assets/img/img-offer-details-mob1.jpg" class="lazyload d-block d-lg-none offer-details__image">
         </div>
         <div class="offer-details__col">
            <div class="offer-details__body">
               <h2 class="offer-details__title">Тримайте заряд! Знижка до - 70% на генератори, станції живлення та повербанки </h2>
               <p class="offer-details__date">Акція триває з 04.04.2023 по 30.04.2023</p>
               <p class="offer-details__timer-title">До кінця акції</p>
               <div class="offer-details__timer">
                  <div class="offer-details__timer-item">
                     <div class="offer-details__timer-value offer-details__timer-value_days">00</div>
                     <p class="offer-details__timer-text">днів</p>
                  </div>
                  <span class="offer-details__timer-divider">:</span>
                  <div class="offer-details__timer-item">
                     <div class="offer-details__timer-value offer-details__timer-value_hours">00</div>
                     <p class="offer-details__timer-text">годин</p>
                  </div>
                  <span class="offer-details__timer-divider">:</span>
                  <div class="offer-details__timer-item">
                     <div class="offer-details__timer-value offer-details__timer-value_minutes">00</div>
                     <p class="offer-details__timer-text">хвилин</p>
                  </div>
                  <span class="offer-details__timer-divider">:</span>
                  <div class="offer-details__timer-item">
                     <div class="offer-details__timer-value offer-details__timer-value_seconds">00</div>
                     <p class="offer-details__timer-text">секунд</p>
                  </div>
               </div>
               <p class="offer-details__description">Купуйте генератори, станції живлення або повербанки зі знижками до -70%.</p>
               <div class="offer-details__text">
                  <p class="offer-details__text-opener"><span>Детальні умови акції</span> <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="none" viewBox="0 0 10 10"><g clip-path="url(.aasdf123asd123)"><path fill="#06B071" d="M4.61 7.778.16 3.328A.543.543 0 0 1 0 2.94c0-.147.057-.284.16-.387l.327-.328a.548.548 0 0 1 .774 0l3.737 3.737 3.741-3.74a.543.543 0 0 1 .387-.16c.146 0 .284.056.387.16l.327.327c.103.103.16.24.16.387a.543.543 0 0 1-.16.387L5.386 7.778a.544.544 0 0 1-.388.16.544.544 0 0 1-.388-.16Z"/></g><defs><clipPath class="aasdf123asd123"><path fill="#fff" d="M0 0v10h10V0z"/></clipPath></defs></svg></p>
                  <div class="offer-details__text-holder">
                     <p>Акція діє на території України, окрім тимчасово окупованих територій, на сайті allo.ua з 04.04.2023 до 30.04.2023, або доки акційний товар є у наявності. * Під «знижка до -70%» мається на увазі різниця між звичайними та акційними цінами, що перелічені на сторінці акції. Ціни вказані у гривні з урахуванням ПДВ. Придбання товару на умовах діючої акції підтверджує ознайомлення та згоду споживача з усіма її умовами. Термін проведення може бути змінений за рішенням організатора (ТОВ «АЛЛО»). Про детальні умови дізнайтесь за телефоном гарячої лінії: 0-800-300-100, 0-800-303-123 або на allo.ua. Дзвінки зі стаціонарних та мобільних телефонів (Київстар, Vodafone, Lifecell) в межах України безкоштовні.</p>
                  </div>
               </div>
            </div>
         </div>
...
<div class="catalog catalog-offers">
   <div class="container">
      <div class="catalog__holder">
         ...
         <div class="catalog__content">
            <div class="offers__filter-btn"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 22 22"><g fill="#fff" clip-path="url(.a123124123123)"><path d="M.917 4.354h2.508a3.417 3.417 0 0 0 6.595 0h11.063a.917.917 0 0 0 0-1.833H10.02a3.418 3.418 0 0 0-6.595 0H.917a.917.917 0 0 0 0 1.833Zm5.805-2.52a1.604 1.604 0 1 1 0 3.207 1.604 1.604 0 0 1 0-3.208ZM21.083 10.083h-2.508a3.416 3.416 0 0 0-6.594 0H.917a.917.917 0 0 0 0 1.834H11.98a3.417 3.417 0 0 0 6.594 0h2.508a.917.917 0 0 0 0-1.834Zm-5.805 2.521a1.604 1.604 0 1 1 0-3.208 1.604 1.604 0 0 1 0 3.208ZM21.083 17.646H10.02a3.417 3.417 0 0 0-6.595 0H.917a.917.917 0 0 0 0 1.833h2.508a3.418 3.418 0 0 0 6.595 0h11.063a.917.917 0 0 0 0-1.833Zm-14.361 2.52a1.604 1.604 0 1 1 0-3.207 1.604 1.604 0 0 1 0 3.208Z"/></g><defs><clipPath class="a123124123123"><path fill="#fff" d="M0 0h22v22H0z"/></clipPath></defs></svg>Категорії</div>
            ...
            <div class="catalog__pagination catalog__pagination_last">
               PAGINATION
            </div>
         </div>
      </div>
