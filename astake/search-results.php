		...
		<div class="search__wrap">
			...
			<div class="search__content">
				<div class="search__title">
					...
					<span class="search__counter search__counter_colored">5</span>
				</div>
				<hr class="mt-lg-40 mt-sm-40 mb-lg-40 mb-sm-40">
				<h2 class="title-secondary mb-lg-50 mb-sm-40">Latest Articles</h2>
				...
				<hr class="pt-sm-20 mb-lg-40 mb-sm-40">
				<h2 class="title-secondary mb-lg-50 mb-sm-40">Новости aStake.io</h2>
				<div class="search__grid">
					<div class="search__col">
						<div class="item">
							<a href="article.php">
				...
				<hr class="pt-sm-20 mb-lg-40 mb-sm-40">
				<h2 class="title-secondary mb-lg-50 mb-sm-40">ЧаВо</h2>
				<div class="search__grid">
					<div class="search__col">
						<div class="item">
							<a href="article.php">
				...
				<div class="button-pagination">
					<button class="btn-primary">Show 12 more</button>
					<ul class="pagination">
						<li><span>1</span></li>
						<li><a href="#">2</a></li>
						<li><a href="#">3</a></li>
...
<section class="block-featuring pt-lg-120 pt-sm-60 mb-lg-120 mb-sm-80">
	<div class="container">
		<div class="featuring">
