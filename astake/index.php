...
<section class="block-head">
	<div class="container">
		<h1 class="head__title"><span>The future is already here</span> - we talk about the intricacies of investing in cryptocurrencies and staking</h1>
	</div>
</section>

<section class="block-articles-accent pt-lg-80 pt-sm-40">
	<div class="container">
		<h2 class="title-secondary mb-lg-40 mb-sm-40">Latest publications</h2>
		<div class="articles-accent__grid">
			<div class="articles-accent__col">
				<div class="item-accent">
					<a href="article.php">
						<figure class="item-accent__image bg-cover" style="background-image: url(assets/img/img-item-accent.jpg);">
							<div class="item-accent__content">
								<div class="label">Staking</div>
								<div class="item-accent__info">
									<svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="7.5" cy="7.5" r="6.8" stroke="#fff" stroke-width="1.4"/><path d="M7 4v4l2 1.5" stroke="#fff" stroke-width="1.4" stroke-linecap="round"/></svg>
									<p>15 min.</p>
									<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M7.92 2.804a.8.8 0 0 1 .159 0A11.176 11.176 0 0 1 15.504 6.7a1.872 1.872 0 0 1-.015 2.554c-.61.659-1.616 1.632-2.886 2.446-1.268.812-2.853 1.5-4.603 1.5-1.75 0-3.336-.688-4.604-1.5-1.27-.814-2.275-1.787-2.886-2.446A1.872 1.872 0 0 1 .496 6.7 11.176 11.176 0 0 1 7.92 2.804Zm.08 1.6a9.576 9.576 0 0 0-6.325 3.378.272.272 0 0 0 0 .375l.006.006c.557.602 1.46 1.474 2.579 2.19C5.382 11.072 6.666 11.6 8 11.6s2.618-.528 3.74-1.247c1.117-.716 2.021-1.588 2.578-2.19l.007-.006a.272.272 0 0 0 0-.375A9.576 9.576 0 0 0 8 4.404Z" fill="#fff"/><path fill-rule="evenodd" clip-rule="evenodd" d="M6.02 6.02a2.8 2.8 0 1 1 3.96 3.96 2.8 2.8 0 0 1-3.96-3.96ZM8 6.8a1.2 1.2 0 1 0 0 2.4 1.2 1.2 0 0 0 0-2.4Z" fill="#fff"/></svg>
									<p>4756</p>
								</div>
								<p class="item-accent__title">We believe in the future of dollar-backed stablecoins and their potential </p>
								<p class="item-accent__text">In the months following the announcement, nothing significant happened to Libra. Members left the Libra Association, and in their place came ...</p>
								<div class="btn-secondary">Read article</div>
							</div>
						</figure>
					</a>
				</div>
				<div class="articles-accent__row">
					<div class="articles-accent__col">
						<div class="item">
							<a href="article.php">
		...
		<a href="list.php" class="btn-primary mt-lg-60 mt-sm-40">Read latest</a>
	</div>
</section>

<section class="block-featuring pt-lg-80 pt-sm-60">
	<div class="container">
		<div class="featuring">
			<div class="featuring__image featuring__image_desktop bg-cover" style="background-image: url(assets/img/img-featuring1-desktop.png);"></div>
			<div class="featuring__image featuring__image_mobile bg-cover" style="background-image: url(assets/img/img-featuring1-mobile.png);"></div>
			<div class="featuring__content">
				<div class="featuring__row">
					<div class="featuring__col">
						<p class="featuring__title">It's time to invest in staking</p>
						<p class="featuring__text">aStake.io - staking automation service</p>
					</div>
					<a href="#" class="featuring__button btn-secondary">Learn more</a>
				</div>
			</div>
		</div>
	</div>
...
<div class="container">
	<hr class="mt-lg-80 mt-sm-60">
</div>

<section class="block-articles pt-lg-60 pt-sm-40">
	<div class="container">
		<h2 class="title-secondary mb-lg-40 mb-sm-40">Investments in cryptocurrencies</h2>
		...
		<a href="category.php" class="btn-primary">See all</a>
	</div>
</section>
...
<section class="block-articles pt-lg-80 pt-sm-40">
	<div class="container">
		<h2 class="title-secondary mb-lg-40 mb-sm-40">Staking Technology</h2>
		<div class="articles__grid">
			<div class="articles__col">
				<div class="item">
					<a href="article.php">
...
<section class="block-featuring pt-lg-80 pt-sm-60">
	<div class="container">
		<div class="featuring featuring_second">
			<div class="featuring__image featuring__image_desktop bg-cover" style="background-image: url(assets/img/img-featuring2-desktop.jpg);"></div>
			<div class="featuring__image featuring__image_mobile bg-cover" style="background-image: url(assets/img/img-featuring2-mobile.jpg);"></div>
			<div class="featuring__content featuring__content_second">
				<div class="featuring__row">
					<div class="featuring__col">
						<p class="featuring__title featuring__title_second">Cryptocurrency investment trends are always at hand</p>
						<p class="featuring__text featuring__text_second">Subscribe to our telegram channel and stay up to date with the best crypto investment strategies</p>
					</div>
...
<section class="block-articles pt-lg-80 pt-sm-40">
	<div class="container">
		<h2 class="title-secondary mb-lg-40 mb-sm-40">Category 3 Tape</h2>
		<div class="articles__grid">
			<div class="articles__col">
				<div class="item">
					<a href="article.php">
...
<section class="block-articles pt-lg-80 pt-sm-40">
	<div class="container">
		<h2 class="title-secondary mb-lg-40 mb-sm-40">aStake.io News Feed</h2>
		<div class="articles__grid">
			<div class="articles__col">
				<div class="item">
					<a href="article.php">
...
<section class="block-featuring pt-lg-80 pt-sm-60 mb-lg-120 mb-sm-80">
	<div class="container">
		<div class="featuring">
