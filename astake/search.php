...
<div class="breadcrumbs">
	<div class="container">
		<ul>
			...
			<li>Searching results</li>
		</ul>
	</div>
</div>

<section class="block-search pt-lg-40 pt-sm-20">
	<div class="container">
		<div class="search__wrap">
				...
				<a href="index.php" class="btn-prev">
					<figure>
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M2.66663 8.00008C2.66663 7.82327 2.73686 7.6537 2.86189 7.52868L6.86189 3.52868C7.12224 3.26833 7.54435 3.26833 7.8047 3.52868C8.06505 3.78903 8.06505 4.21114 7.8047 4.47149L4.94277 7.33341L12.6666 7.33341C13.0348 7.33341 13.3333 7.63189 13.3333 8.00008C13.3333 8.36827 13.0348 8.66675 12.6666 8.66675L4.94277 8.66675L7.8047 11.5287C8.06505 11.789 8.06505 12.2111 7.8047 12.4715C7.54435 12.7318 7.12224 12.7318 6.86189 12.4715L2.86189 8.47148C2.73686 8.34646 2.66663 8.17689 2.66663 8.00008Z" fill="#0F0D16"/>
						</svg>
					</figure>
					<span>Back</span>
				</a>
			...
			<div class="search__content">
				<div class="search__title">
					<h1 class="title-primary">Searching results</h1>
					<span class="search__counter">0</span>
				</div>
				<hr class="mt-lg-40 mt-sm-40 mb-lg-40 mb-sm-40">
				<img src="assets/img/placeholder.webp" class="lazyload show-light search__image" data-src="assets/img/img-search1-light.svg" width="108.6" height="122.13">
				<img src="assets/img/placeholder.webp" class="lazyload show-dark search__image" data-src="assets/img/img-search1-dark.svg" width="108.6" height="122.13">
				<p class="search__subtitle mt-lg-40 mt-sm-40">Nothing yet</p>
			</div>
		</div>
	</div>
</section>

<section class="block-featuring pt-lg-120 pt-sm-40 mb-lg-120 mb-sm-80">
	<div class="container">
		<div class="featuring">
